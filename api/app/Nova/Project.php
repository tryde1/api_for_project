...
class Project extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Images::make('Логотип', 'main')->rules('required')
                ->conversionOnIndexView('thumb'),
            URL::make('Видео', 'video'),
            Images::make('Превью', 'images')->rules('required')
            ->conversionOnIndexView('thumb'),
            BelongsToMany::make('Услуги', 'Services', Service::class)->rules('required'),
            BelongsToMany::make('Подуслуги', 'Subservices', Subservice::class)->rules('required'),
            BelongsTo::make('Заказчик', 'customer', Customer::class)->rules('required'),
        ];
    }
